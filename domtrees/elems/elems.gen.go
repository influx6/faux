...
func Anchor(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("a", false)
...
func Abbreviation(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("abbr", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Address(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("address", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Area(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("area", true)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Article(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("article", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Aside(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("aside", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Audio(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("audio", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Bold(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("b", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Base(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("base", true)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func BidirectionalIsolation(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("bdi", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func BidirectionalOverride(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("bdo", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func BlockQuote(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("blockquote", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Break(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("br", true)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Button(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("button", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Canvas(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("canvas", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Caption(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("caption", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Citation(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("cite", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Code(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("code", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Column(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("col", true)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func ColumnGroup(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("colgroup", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Command(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("command", true)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Content(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("content", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Data(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("data", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func DataList(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("datalist", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Description(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("dd", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func DeletedText(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("del", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Details(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("details", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Definition(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("dfn", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Dialog(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("dialog", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Div(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("div", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func DescriptionList(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("dl", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func DefinitionTerm(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("dt", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Element(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("element", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Emphasis(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("em", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Embed(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("embed", true)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func FieldSet(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("fieldset", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func FigureCaption(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("figcaption", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Figure(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("figure", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Font(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("font", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Footer(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("footer", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Form(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("form", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Header(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("header", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func HeadingsGroup(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("hgroup", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func HorizontalRule(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("hr", true)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Italic(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("i", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func InlineFrame(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("iframe", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Image(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("img", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Input(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("input", true)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func InsertedText(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("ins", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func KeyboardInput(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("kbd", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func KeyGen(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("keygen", true)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Label(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("label", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Legend(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("legend", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func ListItem(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("li", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Link(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("link", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Main(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("main", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Map(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("map", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Mark(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("mark", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Menu(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("menu", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func MenuItem(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("menuitem", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Meta(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("meta", true)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Meter(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("meter", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Navigation(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("nav", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func NoFrames(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("noframes", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func NoScript(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("noscript", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Object(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("object", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func OrderedList(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("ol", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func OptionsGroup(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("optgroup", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Option(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("option", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Output(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("output", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Paragraph(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("p", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Parameter(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("param", true)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Picture(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("picture", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Preformatted(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("pre", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Progress(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("progress", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Quote(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("q", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func RubyParenthesis(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("rp", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func RubyText(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("rt", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Rtc(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("rtc", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Ruby(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("ruby", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Strikethrough(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("s", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Sample(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("samp", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Script(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("script", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Section(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("section", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Select(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("select", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Shadow(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("shadow", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Small(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("small", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Source(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("source", true)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Span(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("span", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Strong(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("strong", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Style(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("style", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Subscript(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("sub", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Summary(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("summary", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Superscript(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("sup", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Table(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("table", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func TableBody(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("tbody", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func TableData(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("td", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Template(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("template", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func TextArea(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("textarea", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func TableFoot(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("tfoot", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func TableHeader(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("th", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func TableHead(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("thead", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Time(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("time", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Title(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("title", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func TableRow(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("tr", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Track(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("track", true)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Underline(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("u", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func UnorderedList(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("ul", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Variable(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("var", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Video(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("video", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func WordBreakOpportunity(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("wbr", true)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
func Header1(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("h1", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
// Heading elements implement six levels of document headings, <h1> is the most important and <h6> is the least. A heading element briefly describes the topic of the section it introduces. Heading information may be used by user agents, for example, to construct a table of contents for a document automatically.
// https://developer.mozilla.org/en-US/docs/Web/HTML/Element/Heading_Elements
func Header2(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("h2", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
// Heading elements implement six levels of document headings, <h1> is the most important and <h6> is the least. A heading element briefly describes the topic of the section it introduces. Heading information may be used by user agents, for example, to construct a table of contents for a document automatically.
// https://developer.mozilla.org/en-US/docs/Web/HTML/Element/Heading_Elements
func Header3(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("h3", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
// Heading elements implement six levels of document headings, <h1> is the most important and <h6> is the least. A heading element briefly describes the topic of the section it introduces. Heading information may be used by user agents, for example, to construct a table of contents for a document automatically.
// https://developer.mozilla.org/en-US/docs/Web/HTML/Element/Heading_Elements
func Header4(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("h4", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
// Heading elements implement six levels of document headings, <h1> is the most important and <h6> is the least. A heading element briefly describes the topic of the section it introduces. Heading information may be used by user agents, for example, to construct a table of contents for a document automatically.
// https://developer.mozilla.org/en-US/docs/Web/HTML/Element/Heading_Elements
func Header5(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("h5", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
...
// Heading elements implement six levels of document headings, <h1> is the most important and <h6> is the least. A heading element briefly describes the topic of the section it introduces. Heading information may be used by user agents, for example, to construct a table of contents for a document automatically.
// https://developer.mozilla.org/en-US/docs/Web/HTML/Element/Heading_Elements
func Header6(markup ...domtrees.Appliable) *domtrees.Element {
	e := domtrees.NewElement("h6", false)
	for _, m := range markup {
		m.Apply(e)
	}
	return e
